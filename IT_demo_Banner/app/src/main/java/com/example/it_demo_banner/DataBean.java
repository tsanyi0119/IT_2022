...
//        list.add(new DataBean(R.drawable.image44, "极致简约,梦幻小屋", 3));
//        list.add(new DataBean(R.drawable.image33, "超级卖梦人", 3));
...
//        list.add(new DataBean(R.drawable.image22, "生活的态度", 3));
//        return list;
//    }
...
//        list.add(new DataBean(R.drawable.image10, "洋洋洋.气质篇", 1));
//        list.add(new DataBean(R.drawable.image22, "生活的态度", 1));
//        return list;
//    }
